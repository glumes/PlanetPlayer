...
static void encode(AVCodecContext *encodeCtx, AVFrame *frame, AVPacket *pkt, struct SwsContext * swsCtx,FILE* outputFile){
    int ret;
...
TEST(PlanetTest,scale_H264_test){
    ...
    swsCtx = sws_getContext(640,480,AV_PIX_FMT_YUV420P,320,240,AV_PIX_FMT_YUV420P,SWS_BILINEAR, nullptr, nullptr,
                             nullptr);
